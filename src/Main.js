...
class Main extends Component {
    ...
    render() {
        ...
        let hornedBeastsArry = [
          ...
          let  horneBeastArryAfter = [];

          for (const [index, value] of hornedBeastsArry.entries()) {
            horneBeastArryAfter.push(<HornedBeasts
        ...
        return (
            <div>
              ...
              {/* <HornedBeasts image_url={hornedBeastsArry[this.ii].image_url}
              title={hornedBeastsArry[this.ii].title}
              description={hornedBeastsArry[this.ii].description}
              horns={hornedBeastsArry[this.ii].horns}
              /> */}
